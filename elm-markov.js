...
var _mgold$elm_random_pcg$Random_Pcg$independentSeed = _mgold$elm_random_pcg$Random_Pcg$Generator(
	function (seed0) {
		...
		var gen4 = A5(
			...
			gen1,
			gen1);
		var _p77 = A2(_mgold$elm_random_pcg$Random_Pcg$step, gen4, seed0);
		var a = _p77._0._0;
		var b = _p77._0._1;
		var c = _p77._0._2;
		var d = _p77._0._3;
...
var _mgold$elm_random_pcg$Random_Pcg$fastForward = F2(
	function (delta0, _p78) {
		...
		var _p80 = A6(helper, one, zero, _mgold$elm_random_pcg$Random_Pcg$magicFactor, _p81, delta0, true);
		var accMultFinal = _p80._0;
		var accPlusFinal = _p80._1;
		var state1 = A2(
			_mgold$elm_random_pcg$Random_Pcg$add64,
			accPlusFinal,
			A2(_mgold$elm_random_pcg$Random_Pcg$mul64, accMultFinal, _p79._0));
		return A2(_mgold$elm_random_pcg$Random_Pcg$Seed, state1, _p81);
	});
...
var _janiczek$elm_markov$Main$textarea = F2(
...
var _janiczek$elm_markov$Main$input = function (attributes) {
	return A2(
...
var _janiczek$elm_markov$Main$label = function (string) {
	return A2(
...
var _janiczek$elm_markov$Main$button = F2(
	function (attributes, string) {
		return A2(
...
var _janiczek$elm_markov$Main$formGroup = _elm_lang$html$Html$div(
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('form-group')
		]));
var _janiczek$elm_markov$Main$column = _elm_lang$html$Html$div(
	_elm_lang$core$Native_List.fromArray(
		[
...
var _janiczek$elm_markov$Main$rightColumn = function (model) {
	return _janiczek$elm_markov$Main$column(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Generated string')
					])),
				A2(
				_janiczek$elm_markov$Main$textarea,
				_elm_lang$core$Native_List.fromArray(
					[
...
var _janiczek$elm_markov$Main$sanitizeInput = function (input) {
	return A2(
		_elm_lang$core$String$split,
		' ',
		_elm_lang$core$String$trim(input));
};
var _janiczek$elm_markov$Main$update = F2(
	function (msg, model) {
		var _p0 = A2(_elm_lang$core$Debug$log, 'msg', msg);
		switch (_p0.ctor) {
			case 'GenerateString':
				var stateMachine = _janiczek$elm_markov$Markov$fromInputs(
					A2(
						_elm_lang$core$List$map,
						_janiczek$elm_markov$Main$sanitizeInput,
						_elm_lang$core$Dict$values(model.inputs)));
				var _p1 = A2(
					_mgold$elm_random_pcg$Random_Pcg$step,
					A2(_janiczek$elm_markov$Markov$walk, stateMachine, model.length),
					model.randomSeed);
				var generatedList = _p1._0;
				var randomSeed = _p1._1;
				var generatedString = A2(_elm_lang$core$String$join, ' ', generatedList);
				return _elm_lang$core$Native_Utils.update(
					model,
					{randomSeed: randomSeed, generatedString: generatedString});
			case 'UpdateLength':
				var length = A2(
			...
			case 'NewInput':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						inputs: A3(_elm_lang$core$Dict$insert, model.newId, '', model.inputs),
						newId: model.newId + 1
					});
			default:
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						inputs: A2(
							...
							'X',
							A3(_elm_lang$core$Dict$insert, _p0._0, _p0._1, model.inputs))
					});
		}
	});
var _janiczek$elm_markov$Main$initModel = function (_p2) {
	var _p3 = _p2;
	return {
		inputs: A2(_elm_lang$core$Dict$singleton, 0, ''),
		length: 30,
		generatedString: '',
		newId: 1,
		randomSeed: A2(_mgold$elm_random_pcg$Random_Pcg$initialSeed2, _p3.seed1, _p3.seed2)
	};
};
var _janiczek$elm_markov$Main$Flags = F2(
	function (a, b) {
		return {seed1: a, seed2: b};
	});
var _janiczek$elm_markov$Main$Model = F5(
	function (a, b, c, d, e) {
		return {inputs: a, length: b, generatedString: c, newId: d, randomSeed: e};
	});
var _janiczek$elm_markov$Main$UpdateInput = F2(
	function (a, b) {
		return {ctor: 'UpdateInput', _0: a, _1: b};
	});
var _janiczek$elm_markov$Main$viewInput = function (_p4) {
	var _p5 = _p4;
	var _p6 = _p5._0;
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_janiczek$elm_markov$Main$UpdateInput(_p6))
					]),
				_p5._1)
			]));
};
var _janiczek$elm_markov$Main$NewInput = {ctor: 'NewInput'};
var _janiczek$elm_markov$Main$leftColumn = function (model) {
	return _janiczek$elm_markov$Main$column(
		_elm_lang$core$Native_List.fromArray(
			[
				_janiczek$elm_markov$Main$formGroup(
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_elm_lang$html$Html$h2,
						...
						A2(
						_janiczek$elm_markov$Main$button,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_janiczek$elm_markov$Main$NewInput)
							]),
						'Add input'),
						A2(
						_elm_lang$html$Html$div,
						...
						A2(
							_elm_lang$core$List$map,
							_janiczek$elm_markov$Main$viewInput,
							_elm_lang$core$Dict$toList(model.inputs)))
					]))
			]));
};
var _janiczek$elm_markov$Main$UpdateLength = function (a) {
	return {ctor: 'UpdateLength', _0: a};
};
var _janiczek$elm_markov$Main$GenerateString = {ctor: 'GenerateString'};
var _janiczek$elm_markov$Main$middleColumn = function (model) {
	return _janiczek$elm_markov$Main$column(
		_elm_lang$core$Native_List.fromArray(
			[
				_janiczek$elm_markov$Main$formGroup(
				_elm_lang$core$Native_List.fromArray(
					[
						_janiczek$elm_markov$Main$label('Length (in words)'),
						_janiczek$elm_markov$Main$input(
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$type$('number'),
								_elm_lang$html$Html_Events$onInput(_janiczek$elm_markov$Main$UpdateLength),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_janiczek$elm_markov$Main$GenerateString)
					]),
				'Generate!')
			]));
};
var _janiczek$elm_markov$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('elm-markov')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Train the Markov chain and see what it comes up with!')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_janiczek$elm_markov$Main$leftColumn(model),
								_janiczek$elm_markov$Main$middleColumn(model),
								_janiczek$elm_markov$Main$rightColumn(model)
							]))
					]))
			]));
};
var _janiczek$elm_markov$Main$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: function (flags) {
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_janiczek$elm_markov$Main$initModel(flags),
					_elm_lang$core$Native_List.fromArray(
						[]));
			},
			update: F2(
				function (msg, model) {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						A2(_janiczek$elm_markov$Main$update, msg, model),
						_elm_lang$core$Native_List.fromArray(
							[]));
				}),
			view: _janiczek$elm_markov$Main$view,
			subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
		}),
	flags: A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'seed1', _elm_lang$core$Json_Decode$int),
		function (seed1) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(_elm_lang$core$Json_Decode_ops[':='], 'seed2', _elm_lang$core$Json_Decode$int),
				function (seed2) {
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _janiczek$elm_markov$Main$main === 'undefined' ? null : _janiczek$elm_markov$Main$main);
